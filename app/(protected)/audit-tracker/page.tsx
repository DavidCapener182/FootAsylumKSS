...
async function getStoreAudits() {
  ...
  // Known bad rows are corrected by migrations (for example migration 033),
  // so this presentation layer reflects the authoritative stored audit state.
