...
export const EMP_DOWNLOAD_PLAN_VALUES: Record<string, string> = {
  ...
  operational_assumptions_dependencies: lines(
    ...
    'Weather, ground condition, welfare demand, security intelligence, transport demand or route loss may alter deployment, queue layouts, patrol focus or area priorities.',
  ...
  dim_aliced_activity:
    'Arrival considerations affecting KSS include Wednesday and Thursday campsite arrival, accessibility campsite entry and search support, arena opening, Co-Op and bar first-contact points, Paddock access, queue readiness, accessible arrival support and welfare recognition at the first point of contact.',
  dim_aliced_location:
    'Last-mile factors include Donington Park walking distances, mixed terrain, tarmac routes, car parks, transport hub, PUDO, coach and shuttle interfaces, accessible drop-off, service routes and vehicle interfaces. Accessibility campsite areas at grids W16 to S16 and R09 require route awareness and careful welfare escalation.',
  dim_aliced_ingress:
  ...
  dim_aliced_dynamics:
    'Dispersal risks are highest when alcohol, fatigue, loud environments, long walking distances, disability needs, sensory overload, poor weather, crowd frustration and late-night campsite returns combine. Safeguarding and welfare escalation will be treated as a live operational control during departure and campsite return, not an after-action process.',
  ...
  ramp_arrival:
    'KSS static and dynamic gathering spaces include bar footprints and queue tails, the Co-Op shop frontage and queue lane, accessibility campsite search points, Accessible Campsite A4 and D, Accessibility Black Campsite, Paddock dwell areas, welfare/medical handover points and service interfaces. Each area requires a clear footprint, visible boundary, holding capacity, accessible route protection and supervisor review during peak times.',
  ramp_movement:
    'Movement demand will build around bars, the Co-Op shop, accessible campsite interfaces, District X services and arena egress. KSS will prevent queue spillback into main routes and support customers who need welfare, medical or accessibility assistance.',
  ramp_profile:
  ...
  density_assumptions:
    'KSS will manage queues at conservative densities and intervene before stop-start movement, barrier loading, route encroachment, accessibility obstruction, distress, overheating or conflict develops. Co-Op shop queues will be treated as high-demand public queues when shop demand, product availability or customer flow creates a surge.',
  ...
  response_teams: lines(
    'KSS response pair/team - Support refusals, Co-Op shop peak demand, route compromise, welfare escort and supervisor requests.',
    ...
    'Bar response - Support service refusal conflict, peak queue demand, Challenge 21 escalation, proxy-purchase concerns and ejection requests.',
  ...
  dynamic_escalation_triggers: lines(
    ...
    'Sustained stop/start movement, barrier loading, crowd compression, customer distress, overheating or inability to leave a queue freely.',
    ...
    'Co-Op shop or bar demand exceeding the planned queue footprint, causing uncontrolled dwell, entry demand, exit conflict or shop/service suspension risk.'
  ),
  ...
  circulation_controls:
    'KSS protects circulation around bars, Co-Op shop, Paddock and accessibility campsites through fixed observation, queue marshal reporting, patrols and supervisor intervention. The working method is active and supervisory: route width is checked repeatedly, queue tails are repositioned before they drift into circulation, accessible users are given space rather than moved through congested areas, and service or stock movements are held where public density makes movement unsafe.',
  high_density_controls:
    'High-density controls apply to the Co-Op shop when shop entry, exit or queue demand exceeds the planned footprint. Controls include queue caps, barriered feeder lanes, protected shop ingress and egress, soft holds, staff reinforcement, welfare observation, public communication, stopping entry or shop access if needed and preserving accessible routes.',
  internal_queue_controls:
    'Internal queues will be actively managed so they do not block emergency exits, accessible routes, medical/welfare routes, toilets, stock routes or public circulation. Queue tails are monitored and reported, and vulnerable or distressed persons are moved away from queue congestion for welfare support.',
  ...
  egress_operations:
    'Egress operations include bar wind-down, queue clear-down, Co-Op shop closure, asset checks, accessible route protection, wristband checks where tasked, welfare monitoring and SITREPs to Event Control until the area is stood down. Queue collapse is managed by closing the queue tail first, stopping new joiners, keeping exit channels open, removing or opening barriers only when crowd conditions allow, directing customers to the agreed route split and holding local movement if Event Control reports downstream congestion.',
  ...
  risk_assessment_methodology:
    'This operational risk assessment is limited to the KSS Download delivery scope. It is not an assessment of the organiser, operator or other contractor regulatory conformity, and it does not replace their own risk assessments or legal/regulatory duties. It is derived from the KSS Download scope, supplied CSMP, Safeguarding and Welfare Plan, FAB Safeguarding Policy, selected annexes, site profile and dynamic risk assessment, with focus on bars, Co-Op shop, accessibility campsite operations, search support, welfare, safeguarding, ejection/eviction pause and emergency interface duties.',
  ...
  shelter_procedure:
    'Shelter may be required for severe weather, lightning or other environmental conditions. KSS identifies local shelter options, prevents congestion at shelter points, supports disabled guests and vulnerable persons and keeps emergency routes available.',
  show_stop_triggers:
    'Show stop triggers include unsafe crowd density or congestion, major medical or safeguarding incident, fire or smoke, structural concern, severe weather, hostile threat, route loss, uncontrolled Co-Op demand surge, serious disorder or any incident where continued service/activity increases risk.',
  rendezvous_points:
  ...
  debrief_reporting:
    'KSS supervisors complete daily debriefs covering bar refusals, Co-Op shop peak-demand issues, accessibility campsite incidents, searches, welfare referrals, safeguarding concerns, Ask for Angela, lost/found persons, ejections/evictions, staff welfare, route issues and recommendations.',
